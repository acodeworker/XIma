...
typedef enum {
    ...
    HMSegmentedControlSegmentWidthStyleCustomize,// Segment width is fixed by user customize
...
/**
 *  by qinggong 2016.10.26
 */
@property (assign, nonatomic) CGFloat segmentWidthEx;
